        ...
        case 'activity/LOAD':
            switch (action.payload.status) {
                ...
                case Status.SUCCEEDED:
                    // TODO in a real app it would be better to keep all the data
                    // and manage loaded and unloaded parts with something like `{ ranges: { from: Day; to: Day; status:Status }[] }`
                    // to avoid re-requesting data
